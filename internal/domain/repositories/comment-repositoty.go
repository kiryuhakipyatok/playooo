...
type CommentRepository interface {
	...
	Fetch(ctx context.Context,whose, id string, amount, page int) ([]entities.Comment, error)
	Add(ctx context.Context,whom, id, cid string) error
}
...
func (cr *commentRepository) Add(ctx context.Context,whom, id, cid string) error{
	var query string
	switch whom{
	case "user":
